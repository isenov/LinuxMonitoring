...
- Все написанные скрипты запускать на виртуальной машине *Ubuntu Server 20.04 LTS*
...
bash-скрипт. За основу взять скрипт из [**Part 2**](#part-2-исследование-системы) и убрать из него часть, ответственную за сохранение данных в файл.  
